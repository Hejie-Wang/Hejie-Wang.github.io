...
![alt text](assets/使用autofigure项目的说明/image.png)
...
![alt text](assets/使用autofigure项目的说明/image-1.png)
...
![alt text](assets/使用autofigure项目的说明/image-3.png)
...
![alt text](assets/使用autofigure项目的说明/image-4.png)
...
![alt text](assets/使用autofigure项目的说明/image-5.png)

之后返回到API密钥管理页面，就能看到刚刚创建的API密钥，点击密钥旁边的按钮，将其复制到剪贴板中。

![alt text](assets/使用autofigure项目的说明/image-6.png)

就完成了OpenAI API Key的获取。

回到AutoFigure-Edit的网页端，将获取的API Key填入，注意上方按钮选择`自定义`，来输入自定义模型提供商。

![alt text](assets/使用autofigure项目的说明/image-7.png)
...
![alt text](assets/使用autofigure项目的说明/image-8.png)
...
![alt text](assets/使用autofigure项目的说明/image-9.png)

在左侧栏，选择`Settings`->`API Keys`，进入 API Keys 页面。

![alt text](assets/使用autofigure项目的说明/image-10.png)
...
![alt text](assets/使用autofigure项目的说明/figure.png)

说明内置提示词功底很不错，之后生成的png也可以成功转为svg，并且可以在svg编辑器中进行微调。

![alt text](assets/使用autofigure项目的说明/image-11.png)
